...
GROUPS = {
    "place": {
        "tables": ["metros", "venues", "orgs", "flyers", "flyer_activities"],
        "stubs": ["activities"],
        "description": "Place-related models: Metro, Venue, Org, Flyer",
    },
    "people": {
        "tables": ["persons", "staff", "visitors"],
        "stubs": ["metros"],
        "description": "People-related models: Person, Staff, Visitor",
    },
    "events": {
        "tables": [
            "services",
        ...
        "stubs": ["metros", "venues", "orgs", "flyers", "persons", "visitors", "contents", "groups"],
        "description": "Event-related models: Service, Activity, Occurrence, Tag, Registration, RSVP",
    },
    "jobs": {
        "tables": [
            "job_postings",
        ...
        "stubs": ["metros", "orgs", "staff", "activities"],
        "description": "Job-related models: JobPosting, InstructorAssignment, InstructorEvaluation",
    },
    "categories": {
        "tables": ["groups", "tags"],
        "stubs": [],
        "description": "Category-related models: Group, Program, Track, Category, SubCategory, Topic, Tag",
    },
    "content": {
        "tables": [
            "contents",
        ...
        "stubs": ["groups"],
        "description": "Content-related models: Content, Page, Announcement",
    },
    "ext_services": {
